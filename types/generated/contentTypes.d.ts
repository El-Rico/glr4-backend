...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    acceptedterms: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    > &
      Attribute.Private;
    credit: Attribute.Integer & Attribute.DefaultTo<0>;
    email: Attribute.Email &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    lessons: Attribute.Relation<
      ...
      'api::lesson.lesson'
    >;
    occupation: Attribute.Enumeration<['full', 'even', 'odd']> &
      Attribute.Required &
